        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12">
            <section className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
              <h2 className="text-2xl font-bold text-slate-800 mb-6 border-b border-slate-100 pb-4">なぜ両立すべきなのか？</h2>
              <div className="space-y-6 text-slate-600 leading-relaxed">
                ...
                <p>
                  つまり、<strong className="text-slate-800">推薦入試の対策は、一般入試の小論文対策に直結する</strong>のです。逆に、一般入試に向けた英語学習や歴史の知識は、面接での受け答えや入学後の学力の基礎として強力な武器になります。
                </p>
              </div>
            </section>

            <section className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
              <h2 className="text-2xl font-bold text-slate-800 mb-6 border-b border-slate-100 pb-4">両立戦略の具体例</h2>
              
              <div className="space-y-6">
                <div className="border border-slate-100 rounded-xl p-6 bg-slate-50">
                  <h3 className="font-bold text-slate-800 mb-3 text-lg border-l-4 border-[#b38f4f] pl-3">FIT入試 × 法学部一般選抜</h3>
                ...
                <div className="border border-slate-100 rounded-xl p-6 bg-slate-50">
                  <h3 className="font-bold text-slate-800 mb-3 text-lg border-l-4 border-[#b38f4f] pl-3">指定校推薦 × 一般選抜</h3>
                  <p className="text-sm text-slate-600 leading-relaxed">
            ...
            <section className="bg-[#fcfaf5] p-8 rounded-2xl border border-[#eaddc4]">
              <h2 className="text-2xl font-bold text-slate-800 mb-6 border-b border-[#eaddc4] pb-4">オーバーワークを防ぐ「学習管理」</h2>
