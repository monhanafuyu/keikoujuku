...
export const SolutionCycle: React.FC = () => {
  ...
  return (
    <section id="solution" className="py-20 bg-[#050505] border-y border-white/10/80 relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 relative mb-14">
          {SOLUTION_STEPS.map((step, index) => (
            <div
              key={step.stepNumber}
              className="bg-[#0a0a0a] p-5 rounded-2xl border border-white/10/90 shadow-xs hover:border-[#e4cda5] hover:shadow-md transition-all flex flex-col justify-between relative group"
            >
              {/* Top Step Number */}
              <div>
                ...
                <div className="w-10 h-10 rounded-xl bg-white/5 text-slate-200 flex items-center justify-center mb-3 group-hover:bg-[#b38f4f] group-hover:text-white transition-colors">
        ...
        {/* PDCA Loop Banner */}
        <div className="bg-[#0a0a0a] rounded-2xl p-6 sm:p-8 border border-white/10 shadow-xs">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
            ...
            <div className="lg:col-span-2 grid grid-cols-2 sm:grid-cols-4 gap-3">
              <div className="p-3.5 rounded-xl bg-[#b38f4f]/10/70 border border-[#b38f4f]/20 text-center">
                ...
                <span className="text-sm font-black text-white mt-1 block">計画</span>
                <span className="text-[11px] text-slate-400 mt-1 block">日割タスク指定</span>
              </div>
              <div className="p-3.5 rounded-xl bg-emerald-50/70 border border-emerald-100 text-center">
                ...
                <span className="text-sm font-black text-white mt-1 block">実行</span>
                <span className="text-[11px] text-slate-400 mt-1 block">LINE自習報告</span>
              </div>
              <div className="p-3.5 rounded-xl bg-amber-50/70 border border-amber-100 text-center">
                ...
                <span className="text-sm font-black text-white mt-1 block">確認</span>
                <span className="text-[11px] text-slate-400 mt-1 block">週間確認テスト</span>
              </div>
              <div className="p-3.5 rounded-xl bg-purple-50/70 border border-purple-100 text-center">
                ...
                <span className="text-sm font-black text-white mt-1 block">改善</span>
                <span className="text-[11px] text-slate-400 mt-1 block">次週計画の最適化</span>
              </div>
            </div>
          </div>
        </div>
