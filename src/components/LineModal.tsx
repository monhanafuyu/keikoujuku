...
export const LineModal: React.FC<LineModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/70 backdrop-blur-xs">
      <div className="bg-[#0a0a0a] rounded-3xl max-w-md w-full p-6 sm:p-8 shadow-2xl border border-white/10 relative animate-in fade-in zoom-in-95 duration-200">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="text-center space-y-4">
          ...
          {/* QR Code Mock Box */}
          <div className="p-5 bg-[#050505] rounded-2xl border border-white/10 inline-block mx-auto">
            {/* SVG QR Code Simulation */}
            <div className="w-40 h-40 bg-[#0a0a0a] p-2 rounded-xl shadow-xs border border-white/10 flex flex-col items-center justify-center relative">
              ...
              <span className="text-[9px] font-bold text-slate-400 absolute bottom-1">
                @passgate_exam
              </span>
            </div>
          ...
          <div className="space-y-2 text-left bg-emerald-50/50 p-4 rounded-xl border border-emerald-100 text-xs text-slate-300">
