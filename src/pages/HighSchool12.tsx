...
export const HighSchool12: React.FC = () => {
  return (
    <PageTemplate>
      <SEO 
        title="高1・高2から始める慶應合格戦略｜年間学習スケジュールと科目別勉強法｜慶應ROUTE"
        description="高1・高2から慶應義塾大学合格を目指す受験生のための年間学習スケジュールと勉強法。一般選抜・FIT入試・SFC総合型・指定校推薦すべての選択肢を残す英語基礎の完成法、評定平均キープ術、部活動との両立戦略を現役慶應生が伝授。"
        keywords="高2 慶應 合格 スケジュール, 高2 勉強法 慶應, 慶應義塾大学 高2から, 慶應義塾大学 高1から, 慶應 受験戦略 高1 高2"
