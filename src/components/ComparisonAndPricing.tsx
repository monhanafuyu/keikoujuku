      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-32">
          ...
          <div className="overflow-x-auto pb-6">
            <table className="w-full min-w-[800px] border-collapse bg-[#0a0a0a] shadow-sm border border-white/10">
              <thead>
                <tr>
                  <th className="w-1/5 p-4 text-left font-bold text-slate-400 border-b-2 border-white/10">項目</th>
                  <th className="w-1/5 p-4 text-center font-bold text-slate-400 bg-[#050505] border-b-2 border-white/10">一般的な予備校</th>
                  <th className="w-1/5 p-4 text-center font-bold text-slate-400 bg-[#050505] border-b-2 border-white/10">一般的な学習管理塾</th>
                  <th className="w-1/5 p-4 text-center font-bold text-slate-400 bg-[#050505] border-b-2 border-white/10">推薦専門塾</th>
              ...
              <tbody className="text-sm">
                {[
                  ...
                  <tr key={idx} className="border-b border-white/10 last:border-0 hover:bg-[#050505] transition-colors">
                    <td className="p-4 font-bold text-slate-300 bg-[#0a0a0a]">{row.label}</td>
                    <td className="p-4 text-center text-slate-400 bg-[#050505]/50">{row.a}</td>
                    <td className="p-4 text-center text-slate-400 bg-[#050505]/50">{row.b}</td>
                    <td className="p-4 text-center text-slate-400 bg-[#050505]/50">{row.c}</td>
        ...
        <div id="plans" className="pt-24 border-t border-white/10">
          ...
          <div className="max-w-5xl mx-auto space-y-0 relative bg-[#0a0a0a] border border-white/10 shadow-sm p-8 md:p-12 rounded-sm">
            
            {/* Horizontal Course List */}
            <div className="border-b border-white/10 pb-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-8 relative pl-6">
              {/* Left Gold Border */}
              <div className="absolute left-0 top-6 md:top-1/2 md:-translate-y-1/2 w-[3px] h-12 bg-[#b38f4f]"></div>

              <div className="flex-1 max-w-2xl">
                <h3 className="text-xl font-serif text-white font-bold mb-4 tracking-widest">個別指導コース</h3>
              ...
              <div className="md:text-right shrink-0 mt-4 md:mt-0">
                <div className="text-3xl font-serif text-[#b38f4f] tracking-wider mb-2 font-bold">¥29,800<span className="text-sm text-slate-400 font-sans tracking-normal font-normal ml-1">(税込)</span></div>
                <div className="text-sm text-slate-400 tracking-wide">月4回・1回60分</div>
              </div>
            </div>
            ...
            <div className="pt-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-8 relative pl-6">
              ...
              <div className="flex-1 max-w-2xl">
                <h3 className="text-xl font-serif text-white font-bold mb-4 tracking-widest">学習管理サポートコース</h3>
                <p className="text-slate-300 text-sm leading-relaxed tracking-wide">
              ...
              <div className="md:text-right shrink-0 mt-4 md:mt-0">
                <div className="text-3xl font-serif text-[#b38f4f] tracking-wider mb-2 font-bold">¥10,000<span className="text-sm text-slate-400 font-sans tracking-normal font-normal ml-1">(税込)</span></div>
                <div className="text-sm text-slate-400 tracking-wide">月額</div>
              </div>
            </div>
