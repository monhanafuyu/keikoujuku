...
export const KeioIppan: React.FC = () => {
  return (
    <PageTemplate>
      <SEO 
        title="慶應義塾大学一般選抜対策専門塾｜学部別配点戦略・英語小論文勉強法・過去問指導｜慶應ROUTE"
        description="慶應義塾大学（法・経済・商・文・SFC・理工）の一般選抜を現役慶應生が個別指導。英語長文・小論文・歴史（日本史・世界史）の独自傾向に特化した年間スケジュール、参考書ルート、過去問演習で逆転合格へ導きます。"
        keywords="慶應 一般選抜 対策, 慶応 合格 勉強法, 慶應義塾大学 受験勉強 いつから, 慶応 法学部 対策, 慶応 英語 小論文 対策"
