      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Link to="/column/sougougata-ippan-ryouritsu" className="p-4 bg-white border border-slate-200 rounded-sm hover:border-[#B38F4F] transition-all group flex justify-between items-center">
              <span className="text-sm font-bold text-slate-800 group-hover:text-[#B38F4F]">総合型選抜と一般選抜は両立できる？メリットと注意点</span>
              <ChevronRight className="w-4 h-4 text-[#B38F4F] shrink-0" />
            </Link>
            <Link to="/column/recommendation-and-general-exam" className="p-4 bg-white border border-slate-200 rounded-sm hover:border-[#B38F4F] transition-all group flex justify-between items-center">
              <span className="text-sm font-bold text-slate-800 group-hover:text-[#B38F4F]">推薦を狙いながら一般入試の勉強を続けるべき理由</span>
              <ChevronRight className="w-4 h-4 text-[#B38F4F] shrink-0" />
            </Link>
          </div>
        </section>
