...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F5] text-slate-900 font-sans selection:bg-[#B38F4F] selection:text-white pb-20 sm:pb-0">
      <SEO 
        title="慶應ROUTE｜現役慶應生による一般・推薦対応の大学受験塾"
        description="現役慶應生による大学受験コーチング。一般選抜・慶應法学部FIT入試・総合型選抜・指定校推薦に対応。志望校から逆算した学習計画・進捗管理から、分からない問題の個別解説までサポートします。"
        canonicalUrl="/"
      />
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 p-3 bg-white/95 backdrop-blur-md border-t border-slate-200 sm:hidden flex shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.1)]">
        <button
          ...
          className="w-full py-4 px-3 rounded-sm bg-[#B38F4F] text-white font-bold text-sm flex items-center justify-center gap-1.5 shadow-md active:scale-[0.98] transition-transform tracking-widest font-serif"
        >
