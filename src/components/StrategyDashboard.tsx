...
import { LayoutDashboard, CheckCircle2, TrendingUp, Award, Clock } from 'lucide-react';

export const StrategyDashboard: React.FC = () => {
  return (
    <section className="py-24 bg-[#FAF9F5]" id="dashboard">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center justify-center px-3 py-1.5 rounded-full bg-[#f3e8d3] text-[#a07c3f] text-xs font-bold tracking-widest mb-6 border border-[#d4b783]/40">
            独自の学習管理システム
          </div>
        ...
        <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-100 overflow-hidden">
          ...
          <div className="bg-slate-900 px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <LayoutDashboard className="w-5 h-5 text-[#d4b783]" />
          ...
          <div className="p-6 sm:p-8 bg-[#FAF9F5]/60 grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* Left Column */}
            <div className="lg:col-span-2 space-y-6">
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white p-5 rounded-xl border border-slate-100 shadow-sm">
                  <div className="text-xs text-slate-400 font-bold mb-1">第一志望学部</div>
                  <div className="text-lg font-black text-slate-800">慶應義塾大学 法学部</div>
                </div>
                <div className="bg-white p-5 rounded-xl border border-slate-100 shadow-sm">
                  <div className="text-xs text-slate-400 font-bold mb-1">併願学部 / 併願校</div>
              ...
              <div className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
                ...
                <div className="space-y-5">
                  {[
                    { label: '一般選抜', progress: '65%', color: 'bg-[#b38f4f]' },
                ...
                <div className="space-y-3">
                  {[
                    ...
                    { title: '小論文 第3回答案作成', tag: '小論文' }
                     ...
                     <div key={i} className="flex items-center justify-between p-3 rounded-lg border border-slate-100 bg-[#FAF9F5]">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
                ...
                <ul className="space-y-4">
                  <li className="flex justify-between items-center border-b border-slate-50 pb-3">
                    <span className="text-xs font-bold text-slate-400">学校評定</span>
                    <span className="text-sm font-black text-slate-800">4.3</span>
                  </li>
                  <li className="flex justify-between items-center border-b border-slate-50 pb-3">
                    <span className="text-xs font-bold text-slate-400">英検</span>
                    <span className="text-sm font-black text-slate-800">準1級取得</span>
                  </li>
                  <li className="flex justify-between items-center border-b border-slate-50 pb-3">
                    <span className="text-xs font-bold text-slate-400">全統模試偏差値</span>
                    <span className="text-sm font-black text-slate-800">英語 62.5</span>
                  </li>
                  <li className="flex justify-between items-center pb-1">
                    <span className="text-xs font-bold text-slate-400">活動実績</span>
              ...
              <div className="bg-[#b38f4f] p-6 rounded-xl shadow-md text-white">
                <h3 className="text-sm font-bold text-[#f3e8d3] mb-2 flex items-center gap-2">
                ...
                <p className="text-xs text-[#FAF9F5]/90">今週の学習計画は順調に進んでいます。</p>
              </div>
