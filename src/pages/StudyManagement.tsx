        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12">
            <section className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
              <h2 className="text-2xl font-bold text-slate-800 mb-6 border-b border-slate-100 pb-4">学習管理のサイクル</h2>
              <div className="space-y-8">
                <div>
                  <h3 className="font-bold text-slate-800 mb-2 text-lg">1. 年間・月間計画の作成</h3>
                  <p className="text-slate-600 text-sm leading-relaxed">志望学部と現在の学力のギャップを測り、入試本番から逆算した大きな学習スケジュール（ロードマップ）を作成します。ここで使用する参考書や問題集のルートも確定します。</p>
                </div>
                <div>
                  <h3 className="font-bold text-slate-800 mb-2 text-lg">2. 週間計画（宿題）の提示</h3>
                  <p className="text-slate-600 text-sm leading-relaxed">月間計画をさらに細分化し、「今週はどの参考書の何ページから何ページまでを、どのように進めるか」を明確に指示します。生徒は「今日何を勉強すべきか」迷うことがなくなります。</p>
                </div>
                <div>
                  <h3 className="font-bold text-slate-800 mb-2 text-lg">3. 確認テストと進捗面談</h3>
                  <p className="text-slate-600 text-sm leading-relaxed">毎週の指導時間に確認テストを行い、定着度を測ります。計画通りに進まなかった場合は原因を一緒に分析し、次週の計画を修正します。</p>
                </div>
                <div>
                  <h3 className="font-bold text-slate-800 mb-2 text-lg">4. 質問指導と過去問分析</h3>
                  <p className="text-slate-600 text-sm leading-relaxed">自習中に分からない問題があれば、チャットや面談でいつでも現役慶應生に質問できます。直前期には過去問の添削と分析を行い、得点力を高めます。</p>
                </div>
              </div>
            </section>

            <section className="bg-[#fcfaf5] p-8 rounded-2xl border border-[#eaddc4]">
              <h2 className="text-2xl font-bold text-slate-800 mb-6 border-b border-[#eaddc4] pb-4">普通の塾・予備校との違い</h2>
