...
export const StudyPlanDemo: React.FC = () => {
  ...
  return (
    <section id="plan-demo" className="py-20 bg-white relative">
            ...
            <div className="space-y-3">
              {SAMPLE_STUDY_PLAN_ITEMS.map((item, i) => (
                ...
                >
                  ...
                  <div className="bg-white p-3 rounded-xl border border-slate-200/80 text-xs space-y-1 mb-2">
                    <div className="flex items-start gap-2">
                      <span className="text-slate-400 font-bold shrink-0">指定範囲:</span>
                      <span className="font-bold text-slate-800">{item.scope}</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-slate-400 font-bold shrink-0">勉強手順:</span>
                      <span className="text-slate-600">{item.dailyDetail}</span>
                    </div>
                  </div>
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex items-start gap-2">
                      ...
                      />
                      <div>
                        <span className="font-bold text-[11px] px-1.5 py-0.2 rounded bg-slate-200 text-slate-700 mr-1.5">
                          {t.subject}
                        </span>
                        <p className="font-medium text-slate-900 mt-1 leading-snug">
                          {t.task}
                        </p>
                      </div>
                    </div>
