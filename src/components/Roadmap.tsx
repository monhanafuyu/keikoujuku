    ...
    <section className="py-24 bg-white" id="roadmap">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center justify-center px-3 py-1.5 rounded-full bg-[#FAF9F5] text-[#a07c3f] text-xs font-bold tracking-widest mb-6 border border-[#f3e8d3]">
            高1・高2からの戦略
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between mb-12 sm:mb-20">
              ...
              <div className="w-full sm:w-[45%] pl-24 sm:pl-12 pt-2 sm:pt-0">
                ...
                <div className="bg-[#FAF9F5] rounded-xl p-5 border border-slate-100">
                  <ul className="space-y-3">
                    {['学習習慣の定着', '定期テスト対策', '評定の確保', '英語の基礎固め'].map((item, i) => (
                      <li key={i} className="flex items-center gap-3 text-slate-700 font-medium">
                        <CheckCircle2 className="w-5 h-5 text-[#b38f4f] shrink-0" />
                        <span>{item}</span>
                      </li>
                    ))}
                  </ul>
            ...
            <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between">
              ...
              <div className="w-full sm:w-[45%] pl-24 sm:pl-12 pt-2 sm:pt-0">
                ...
                <div className="bg-[#FAF9F5] rounded-xl p-6 border border-[#f3e8d3] shadow-sm relative overflow-hidden">
                  ...
                  <div className="grid grid-cols-2 gap-3 relative z-10">
                    {['一般選抜', 'FIT入試', '総合型選抜', '指定校推薦'].map((item, i) => (
                      <div key={i} className="bg-white px-3 py-2 rounded-lg text-center font-bold text-slate-800 shadow-sm border border-[#f3e8d3] text-sm">
                        {item}
                      </div>
                    ))}
                  </div>
