...
export const Shiteiko: React.FC = () => {
  return (
    <PageTemplate>
      <SEO 
        title="慶應義塾大学の指定校推薦対策｜評定平均4.8獲得・校内選考・一般入試両立指導｜慶應ROUTE"
        description="慶應義塾大学の指定校推薦を勝ち取るための評定平均（4.5〜5.0）確保、定期テスト対策、校内選考・面接突破法を徹底指導。万が一の校内選考落ちを防ぐ「一般選抜との両立戦略」を現役慶應生が完全サポート。"
        keywords="慶應 指定校推薦, 慶應義塾大学 指定校推薦 評定平均, 慶應義塾大学 指定校推薦 条件, 指定校推薦 校内選考 基準 評定 面接, 指定校推薦 一般入試 両立"
