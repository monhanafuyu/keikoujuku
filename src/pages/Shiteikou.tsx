      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white border border-slate-200 p-6 rounded-sm shadow-sm">
              ...
              <h3 className="text-lg font-serif font-bold text-slate-900 mb-3">① 定期テスト評定対策</h3>
            ...
            <div className="bg-white border border-slate-200 p-6 rounded-sm shadow-sm">
              ...
              <h3 className="text-lg font-serif font-bold text-slate-900 mb-3">② 英検等の資格取得</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
            ...
            <div className="bg-white border border-slate-200 p-6 rounded-sm shadow-sm">
              ...
              <h3 className="text-lg font-serif font-bold text-slate-900 mb-3">③ 志望理由書・面接指導</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Link to="/column/shiteikou-ippan-ryouritsu-kou1" className="p-4 bg-white border border-slate-200 rounded-sm hover:border-[#B38F4F] transition-all group flex justify-between items-center">
              <span className="text-sm font-bold text-slate-800 group-hover:text-[#B38F4F]">指定校推薦と一般入試は両立できる？高1・高2からの受験戦略</span>
              <ChevronRight className="w-4 h-4 text-[#B38F4F] shrink-0" />
            </Link>
            <Link to="/column/shiteikou-kou1-todo" className="p-4 bg-white border border-slate-200 rounded-sm hover:border-[#B38F4F] transition-all group flex justify-between items-center">
              <span className="text-sm font-bold text-slate-800 group-hover:text-[#B38F4F]">指定校推薦を狙う高校1年生がやるべきこと</span>
              <ChevronRight className="w-4 h-4 text-[#B38F4F] shrink-0" />
            </Link>
          </div>
        </section>
